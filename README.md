...
┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━╇━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ gemini-3.1-pro-preview           │    480 │   100.00% │  0.0000% │  0.00% │  1,760,355 │ $21.1608 │                          0.0000% │                          0.0000% │
│ claude-opus-4-6_thinking-high    │    480 │    99.79% │  0.0000% │  0.21% │    750,958 │ $18.9302 │                        100.0000% │                          0.2083% │
│ o3-2025-04-16-medium             │    480 │    99.79% │  0.0000% │  0.21% │  1,102,422 │ $44.2534 │                        899.5261% │                          1.8740% │
│ gpt-5-medium                     │    480 │    99.58% │  0.0000% │  0.42% │    912,416 │  $9.1437 │                          0.0001% │                          0.0000% │
│ gpt-5.3-codex-medium             │    480 │    99.17% │  0.0000% │  0.83% │    195,527 │  $2.7648 │                          0.0026% │                          0.0000% │
│ gpt-5.5-medium                   │    480 │    99.17% │  0.0000% │  0.83% │    164,770 │  $5.0214 │                          0.1185% │                          0.0010% │
│ gpt-5.4-medium                   │    480 │    98.96% │  0.0000% │  1.04% │    217,615 │  $3.3034 │                      39960.0000% │                        416.2500% │
...
│ gemini-3-flash-preview           │    480 │    96.25% │  0.0000% │  3.75% │  3,626,926 │  $9.0728 │                          0.0000% │                          0.0000% │
│ gpt-5.4-nano-medium              │    480 │    95.83% │  0.0000% │  4.17% │    410,559 │  $0.5163 │                          0.1779% │                          0.0074% │
│ o4-mini-2025-04-16-medium-4k     │    480 │    93.54% │  0.0000% │  6.46% │  1,083,780 │  $6.7416 │                          0.0010% │                          0.0001% │
│ gpt-5.4-mini-medium              │    480 │    92.50% │  0.0000% │  7.50% │    414,749 │  $1.8781 │                       5574.3278% │                        418.0746% │
│ claude-sonnet-4-6_thinking-high  │    480 │    91.04% │  0.0000% │  8.96% │    618,002 │  $9.3638 │                          4.4133% │                          0.3954% │
...
│ claude-opus-4-6                  │    480 │    83.54% │  0.0000% │ 16.46% │    137,802 │  $3.5317 │                          3.7950% │                          0.6246% │
...
│ claude-haiku-4-5_thinking_16000  │    480 │    77.29% │  0.0000% │ 22.71% │  1,251,458 │  $6.2885 │                       1843.1035% │                        418.5381% │
│ claude-sonnet-4-20250514-thinki… │    480 │    76.04% │  0.0000% │ 23.96% │  1,332,908 │ $20.0859 │                       1737.7871% │                        416.3448% │
│ minimax-m2.1                     │    480 │    75.42% │  0.0000% │ 24.58% │    750,536 │  $0.9099 │                        136.3989% │                         33.5314% │
│ claude-sonnet-4-6                │    480 │    75.21% │  0.0000% │ 24.79% │     91,631 │  $1.4265 │                          0.8645% │                          0.2143% │
...
│ claude-opus-4-20250514-thinking… │    480 │    65.83% │  0.0000% │ 34.17% │    396,158 │ $30.1734 │                       1831.0146% │                        625.5967% │
│ lmstudio/gemma-4-12b-qat@q4_0    │    480 │    65.83% │ 24.7917% │  9.38% │  2,682,989 │  $0.0000 │                          0.0457% │                          0.0057% │
...
│ claude-sonnet-3.7-20250219-thin… │    480 │    57.08% │ 18.9583% │ 23.96% │  1,214,269 │ $18.3064 │                        888.6875% │                        262.7225% │
│ gemini-2.5-pro-preview-03-25     │    480 │    55.83% │  0.0000% │ 44.17% │      5,517 │  $0.0780 │                         20.6015% │                          9.0990% │
│ qwen3-14b@iq4_xs-ctx32k-thinkin… │    480 │    55.21% │  0.0000% │ 44.79% │    710,967 │  $0.0000 │                       1029.8199% │                        461.2735% │
│ gemini-2.5-pro                   │    480 │    54.58% │  0.0000% │ 45.42% │    454,205 │  $4.5649 │                          7.7444% │                          3.5173% │
│ gemini-2.5-pro                   │    480 │    54.37% │  0.0000% │ 45.62% │      5,380 │  $0.0766 │                          5.8447% │                          2.6666% │
│ claude-opus-4-7_adaptive-thinki… │    480 │    52.71% │  0.0000% │ 47.29% │      6,511 │  $0.2734 │                       2205.3450% │                       1042.9444% │
│ claude-sonnet-3.7-20250219-4k    │    480 │    52.50% │  0.0000% │ 47.50% │      4,213 │  $5.8709 │                       2211.3448% │                       1050.3888% │
│ gemini-3.1-flash-lite-preview    │    480 │    52.08% │  0.0000% │ 47.92% │      5,607 │  $0.0130 │                          5.6481% │                          2.7064% │
│ claude-opus-4-8_adaptive-thinki… │    480 │    51.88% │  0.0000% │ 48.12% │      5,327 │  $0.2319 │                       2599.8511% │                       1251.1783% │
...
│ nemotron-super-3-120b            │    480 │    51.04% │  0.0000% │ 48.96% │      8,985 │  $0.0098 │                             inf% │                             inf% │
...
│ gemini-2.5-flash-preview-04-17-… │    480 │    50.42% │  0.0000% │ 49.58% │    521,284 │  $0.3156 │                         28.1963% │                         13.9807% │
│ claude-sonnet-4-20250514         │    480 │    50.00% │  0.0000% │ 50.00% │      4,125 │  $0.1139 │                         15.8273% │                          7.9137% │
│ claude-haiku-4-5                 │    480 │    49.79% │  0.0000% │ 50.21% │      4,049 │  $0.0376 │                         44.3813% │                         22.2831% │
│ gemini-2.5-flash-preview-04-17-… │    480 │    49.79% │  0.2083% │ 50.00% │    310,022 │  $1.0879 │                        481.6932% │                        241.3494% │
...
│ gemini-2.5-flash-preview-04-17-… │    480 │    48.54% │  0.0000% │ 51.46% │      5,238 │  $0.0060 │                         30.5656% │                         15.7286% │
...
│ kimi-k2.5                        │    480 │    46.88% │  0.0000% │ 53.12% │      3,101 │  $0.0247 │                        420.8277% │                        223.5647% │
│ deepseek.v3.2                    │    480 │    46.67% │  0.0000% │ 53.33% │     51,605 │  $0.0256 │ 2396269220768229025543429266675… │ 1278010251076388669623462732194… │
│ qwen3-32b@cerebras               │    480 │    46.46% │  0.0000% │ 53.54% │      7,457 │  $0.0164 │                        443.5643% │                        237.4917% │
│ deepseek-r1-distill-qwen-14b@iq… │    480 │    46.46% │  0.0000% │ 53.54% │  1,113,604 │  $0.0000 │                     395994.0440% │                     212021.8111% │
...
│ llama4-scout-17b-instruct-v1:0   │    480 │    43.54% │  0.0000% │ 56.46% │      2,836 │  $0.0069 │                     370777.4401% │                     209334.7630% │
│ nemotron-nano-12b-v2             │    480 │    42.71% │  0.0000% │ 57.29% │     11,397 │  $0.0121 │                      74081.0610% │                      42442.2745% │
│ gpt-4-0613                       │    480 │    41.04% │  0.0000% │ 58.96% │      2,450 │  $0.6310 │                     363520.1249% │                     214325.4070% │
│ lmstudio/gemma-4-26b-a4b-qat@q4… │    480 │    39.58% │ 60.4167% │  0.00% │  1,689,256 │  $0.0000 │                          0.0000% │                          0.0000% │
│ gpt-4.1-nano-2025-04-14          │    480 │    38.96% │  0.0000% │ 61.04% │      2,841 │  $0.0027 │                     685997.4621% │                     418744.2841% │
│ magistral-small-2509             │    480 │    37.29% │  0.0000% │ 62.71% │      8,233 │  $0.0223 │                    3437231.9871% │                    2155430.8919% │
...
**Notes:**
- Gemma 4 runs via LM Studio were riddled with errors (model reloads, corrupted responses)
- Seems that Opus 4.7 and 4.8 in adaptive thinking mode choose not to think :) - resutls are poor, token count is minicule
